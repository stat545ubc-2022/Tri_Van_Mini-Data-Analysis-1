...
#apt_buildings %>% unite(col=parking_per_unit,no_of_accessible_parking_spaces, no_of_units, sep="/")
...
```{r}
### Tidy again ###
#tidy<- untidy %>% select(id,PAID,FREE,UNAVAILABLE,BOTH) %>% pivot_longer(cols =c(-id),names_to = "visitor_parking", values_to = "no_of_accessible_parking_spaces")
tidy<- untidy %>% pivot_longer(cols =c("PAID","FREE","UNAVAILABLE","BOTH","NA"),names_to = "visitor_parking", values_to ="no_of_units") # Why anything other than paid does not translate into value?
head(tidy)


```

**Explanation** because apt_buildings is tidy, I un-tidy it and then re-tidy it following the instructions
...
->New question 1: Is building built after year 2000 have more barrier-free accessibility entry then building built before 2000 for the same number of units?
2.  Research question 2: Is there a relationship between the type of visitor parking available and the size of building in term of number of units?
->New question 2: Is there a relationship between the type of visitor parking available and the size of building in term of number of units in building built after year 2000?
...
<!--------------------------- Start your work below --------------------------->
1.  *FILL_THIS_IN* I want to know whether building built after year 2000 have more barrier-free accessibility entry then building built before 2000 for the same number of units. The degree of complexity is enough for me to apply the functions to refine the data.
2.  *FILL_THIS_IN* I want to know whether there a relationship between the type of visitor parking available and the size of building in term of number of units in building built after year 2000. The degree of complexity is enough for me to apply the functions to refine the data.
...
<!--------------------------- Start your work below --------------------------->
#Filter, select, group_by, arrange
*Question 1
```{r}
