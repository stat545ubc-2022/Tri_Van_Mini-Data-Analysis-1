...
untidy<- apt_buildings %>% pivot_wider(names_from = visitor_parking, values_from = no_of_accessible_parking_spaces)
head(untidy)
```
...
tidy<- untidy %>% pivot_longer(cols =c("PAID","FREE","UNAVAILABLE","BOTH","NA"),names_to = "visitor_parking", values_to ="no_of_accessible_parking_spaces") # WHy anything other than paid does not translate into value?
head(tidy)
